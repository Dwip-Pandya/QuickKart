        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-9 product-listing">
                <div class="product-header">
                    <h1 id="category-title">{{ $subcategory->subcat_name }}</h1>
                    <p class="category-description">Browse our latest {{ $subcategory->subcat_name }} products under {{ $category->category_name }}</p>
                </div>
                <!-- Sorting & Filtering -->
